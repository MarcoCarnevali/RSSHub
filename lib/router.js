...
// Picuki
router.get('/picuki/profile/:id/:category', lazyloadRouteHandler('./routes/picuki/profile'));
router.get('/picuki/tag/:id/:displayVideo?', lazyloadRouteHandler('./routes/picuki/tag'));
